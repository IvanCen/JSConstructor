...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(event) {
      ...
      var newBlock = type === 'title' ? new _blocks.TextBlock(value, {
        styles: styles
...
}), new _blocks.TextBlock('Введите текст и стили слева в форму и добавьте новый элемент на сайт', {
  styles: {
    background: 'linear-gradient(to left, #f2994a, #f2c94c)',
    padding: '1rem',
    'font-weight': 'bold'
  }
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript, без использования библиотек', 'Нажатие одной кнопки отделяет тебя от нового элемента!', 'JavaScript - это просто, интересно. Научись создавать любые UI своими руками'], {
  styles: {
...
},{"./styles/main.css":"styles/main.css","./classes/app":"classes/app.js","./model":"model.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
